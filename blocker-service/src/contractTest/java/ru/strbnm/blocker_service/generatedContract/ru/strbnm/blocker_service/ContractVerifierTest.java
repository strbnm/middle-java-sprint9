	...
	public void validate_shouldCheckCashTransactionOn100000RUBWithIsBlockedFalse() throws Exception {
		// given:
			WebTestClientRequestSpecification request = given()
					...
					.body("{\"transactionId\":767936980,\"currency\":\"RUB\",\"amount\":100000.0,\"actionType\":\"GET\"}");
		...
		// and:
			...
			assertThatJson(parsedJson).field("['transactionId']").isEqualTo(767936980);
	...
	public void validate_shouldCheckCashTransactionWithIsBlockedFalse() throws Exception {
		// given:
			WebTestClientRequestSpecification request = given()
					.header("Content-Type", "application/json")
					.header("Accept", "application/json")
					.body("{\"transactionId\":1025573789,\"currency\":\"RUB\",\"amount\":1000.0,\"actionType\":\"PUT\"}");
		...
		// and:
			DocumentContext parsedJson = JsonPath.parse(response.getBody().asString());
			assertThatJson(parsedJson).field("['transactionId']").isEqualTo(1025573789);
			assertThatJson(parsedJson).field("['isBlocked']").isEqualTo(false);
			assertThatJson(parsedJson).field("['reason']").isNull();
	}
	...
	public void validate_shouldCheckCashTransactionWithIsBlockedTrue() throws Exception {
		// given:
			WebTestClientRequestSpecification request = given()
					.header("Content-Type", "application/json")
					.header("Accept", "application/json")
					.body("{\"transactionId\":1834574483,\"currency\":\"USD\",\"amount\":2000.0,\"actionType\":\"GET\"}");
		...
		// and:
			DocumentContext parsedJson = JsonPath.parse(response.getBody().asString());
			assertThatJson(parsedJson).field("['transactionId']").isEqualTo(1834574483);
	...
	public void validate_shouldCheckTransferTransactionItselfWithIsBlockedFalse() throws Exception {
		// given:
			WebTestClientRequestSpecification request = given()
					.header("Content-Type", "application/json")
					.header("Accept", "application/json")
					.body("{\"transactionId\":256185768,\"fromCurrency\":\"USD\",\"toCurrency\":\"RUB\",\"amount\":1000.0,\"isItself\":true}");
		...
		// and:
			DocumentContext parsedJson = JsonPath.parse(response.getBody().asString());
			assertThatJson(parsedJson).field("['transactionId']").isEqualTo(256185768);
			assertThatJson(parsedJson).field("['isBlocked']").isEqualTo(false);
			assertThatJson(parsedJson).field("['reason']").isNull();
	}
	...
	public void validate_shouldCheckTransferTransactionOtherRUB2CNYWithIsBlockedFalse() throws Exception {
		// given:
			WebTestClientRequestSpecification request = given()
					.header("Content-Type", "application/json")
					.header("Accept", "application/json")
					.body("{\"transactionId\":55326418,\"fromCurrency\":\"RUB\",\"toCurrency\":\"CNY\",\"amount\":200000.0,\"isItself\":false}");
		...
		// and:
			DocumentContext parsedJson = JsonPath.parse(response.getBody().asString());
			assertThatJson(parsedJson).field("['transactionId']").isEqualTo(55326418);
			assertThatJson(parsedJson).field("['isBlocked']").isEqualTo(false);
			assertThatJson(parsedJson).field("['reason']").isNull();
	}
	...
	public void validate_shouldCheckTransferTransactionOtherWithIsBlockedFalse() throws Exception {
		// given:
			WebTestClientRequestSpecification request = given()
					.header("Content-Type", "application/json")
					.header("Accept", "application/json")
					.body("{\"transactionId\":1522880785,\"fromCurrency\":\"CNY\",\"toCurrency\":\"USD\",\"amount\":1000.0,\"isItself\":false}");
		...
		// and:
			DocumentContext parsedJson = JsonPath.parse(response.getBody().asString());
			assertThatJson(parsedJson).field("['transactionId']").isEqualTo(1522880785);
			assertThatJson(parsedJson).field("['isBlocked']").isEqualTo(false);
			assertThatJson(parsedJson).field("['reason']").isNull();
	}
	...
	public void validate_shouldCheckTransferTransactionOtherWithIsBlockedTrue() throws Exception {
		// given:
			WebTestClientRequestSpecification request = given()
					.header("Content-Type", "application/json")
					.header("Accept", "application/json")
					.body("{\"transactionId\":1201867753,\"fromCurrency\":\"USD\",\"toCurrency\":\"RUB\",\"amount\":6001.0,\"isItself\":false}");
		...
		// and:
			DocumentContext parsedJson = JsonPath.parse(response.getBody().asString());
			assertThatJson(parsedJson).field("['transactionId']").isEqualTo(1201867753);
			assertThatJson(parsedJson).field("['isBlocked']").isEqualTo(true);
